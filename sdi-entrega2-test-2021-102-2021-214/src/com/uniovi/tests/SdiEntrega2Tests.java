...
//	}
	...
	public void PR39() {
		...
		PO_NavView.checkElement(driver, "id", "titleOfertas");
		PO_NavView.clickOptionWithId(driver, "barra-menu2", "");
		assertNotNull(PO_MessagesView.checkElement(driver, "text", "No leídos: undefined"));//quitar undefined
	...
	public void PR40() {
		...
		PO_NavView.checkElement(driver, "id", "titleOfertas");
		PO_NavView.clickOptionWithId(driver, "barra-menu2", "");
		assertNotNull(PO_MessagesView.checkElement(driver, "text", "No leídos: undefined"));
	}
